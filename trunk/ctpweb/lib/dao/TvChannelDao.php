<?php
 ...
 /**
  * TvChannel Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve TvChannel object instances. 
  */
...
class TvChannelDao {
    ...
    function load(&$conn, &$valueObject) {
          ...
          $sql = "SELECT * FROM TvChannel WHERE (id = ".$valueObject->getId().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM TvChannel ORDER BY id ASC ";
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM TvChannel WHERE (id = ".$valueObject->getId().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function countAll(&$conn) {
          ...
          $sql = "SELECT count(*) FROM TvChannel";
          $allRows = 0;
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM TvChannel WHERE 1=1 ";
          ...
          if ($valueObject->getIpAdress() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND ipAdress LIKE '".$valueObject->getIpAdress()."%' ";
          }

          if ($valueObject->getPort() != 0) {
              if ($first) { $first = false; }
