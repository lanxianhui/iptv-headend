<?php
 ...
 /**
  * UserRecording Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve UserRecording object instances. 
  */
...
class UserRecordingDao {
     ...
     */
    function getObject(&$conn, $recordingId, $userId) {

          $valueObject = $this->createValueObject();
          $valueObject->setRecordingId($recordingId);
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM UserRecording ORDER BY userId ASC ";
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM UserRecording WHERE (recordingId = ".$valueObject->getRecordingId()." AND ";
          $sql = $sql."userId = ".$valueObject->getUserId().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function countAll(&$conn) {
          ...
          $sql = "SELECT count(*) FROM UserRecording";
          $allRows = 0;
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          if ($valueObject->getRecordingId() != 0) {
