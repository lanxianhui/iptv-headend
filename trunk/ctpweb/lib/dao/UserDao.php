...
class UserDao {
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO User ( userName, password, authToken, ";
          $sql = $sql."quota, enabled, fullName, ";
          $sql = $sql."createdOn, lastLogin) VALUES ('".$valueObject->getUserName()."', ";
          $sql = $sql."'".$valueObject->getPassword()."', ";
          $sql = $sql."'".$valueObject->getAuthToken()."', ";
          $sql = $sql."".$valueObject->getQuota().", ";
          $sql = $sql."'".$valueObject->getEnabled()."', ";
          $sql = $sql."'".$valueObject->getFullName()."', ";
          $sql = $sql."'".$valueObject->getCreatedOn()."', ";
          $sql = $sql."'".$valueObject->getLastLogin()."') ";
          ...
          */
          ...
          if ($row = $conn->nextRow($result)) {
               ...
               //print "Unable to find primary-key for created object!";
               return false;
          }
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE User SET userName = '".$valueObject->getUserName()."', ";
          $sql = $sql."password = '".$valueObject->getPassword()."', ";
          $sql = $sql."authToken = '".$valueObject->getAuthToken()."', ";
          $sql = $sql."quota = ".$valueObject->getQuota().", ";
          $sql = $sql."enabled = '".$valueObject->getEnabled()."', ";
          $sql = $sql."fullName = '".$valueObject->getFullName()."', ";
          $sql = $sql."createdOn = '".$valueObject->getCreatedOn()."', ";
          $sql = $sql."lastLogin = '".$valueObject->getLastLogin()."'";
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          if ($valueObject->getAuthToken() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND authToken LIKE '".$valueObject->getAuthToken()."%' ";
          }

          if ($valueObject->getQuota() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND quota = ".$valueObject->getQuota()." ";
          }

          if ($valueObject->getEnabled() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND enabled LIKE '".$valueObject->getEnabled()."%' ";
          }

          if ($valueObject->getFullName() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND fullName LIKE '".$valueObject->getFullName()."%' ";
          }

          if ($valueObject->getCreatedOn() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND createdOn = '".$valueObject->getCreatedOn()."' ";
          }

          if ($valueObject->getLastLogin() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND lastLogin = '".$valueObject->getLastLogin()."' ";
          }
