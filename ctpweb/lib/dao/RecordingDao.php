<?php
 ...
 /**
  * Recording Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Recording object instances. 
  */
...
class RecordingDao {
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM Recording ORDER BY id ASC ";
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO Recording ( programId, mode, fileName) VALUES (".$valueObject->getProgramId().", ";
          $sql = $sql."'".$valueObject->getMode()."', ";
          $sql = $sql."'".$valueObject->getFileName()."') ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE Recording SET programId = ".$valueObject->getProgramId().", ";
          $sql = $sql."mode = '".$valueObject->getMode()."', ";
          $sql = $sql."fileName = '".$valueObject->getFileName()."'";
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM Recording WHERE (id = ".$valueObject->getId().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM Recording WHERE 1=1 ";
          ...
          if ($valueObject->getProgramId() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND programId = ".$valueObject->getProgramId()." ";
          }

          if ($valueObject->getMode() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND mode LIKE '".$valueObject->getMode()."%' ";
          }

          if ($valueObject->getFileName() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND fileName LIKE '".$valueObject->getFileName()."%' ";
          }
