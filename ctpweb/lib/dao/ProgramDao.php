<?php
 ...
 /**
  * Program Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Program object instances. 
  */
...
class ProgramDao {
    ...
    function load(&$conn, &$valueObject) {
          ...
          $sql = "SELECT * FROM Program WHERE (id = ".$valueObject->getId().") "; 
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO Program ( tvChannelId, title, description, ";
          $sql = $sql."begin, end) VALUES (".$valueObject->getTvChannelId().", ";
          $sql = $sql."'".$valueObject->getTitle()."', ";
          $sql = $sql."'".$valueObject->getDescription()."', ";
          $sql = $sql."'".$valueObject->getBegin()."', ";
          $sql = $sql."'".$valueObject->getEnd()."') ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE Program SET tvChannelId = ".$valueObject->getTvChannelId().", ";
          $sql = $sql."title = '".$valueObject->getTitle()."', ";
          $sql = $sql."description = '".$valueObject->getDescription()."', ";
          $sql = $sql."begin = '".$valueObject->getBegin()."', ";
          $sql = $sql."end = '".$valueObject->getEnd()."'";
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          if ($valueObject->getTvChannelId() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND tvChannelId = ".$valueObject->getTvChannelId()." ";
          }
          ...
          if ($valueObject->getBegin() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND begin = '".$valueObject->getBegin()."' ";
          }

          if ($valueObject->getEnd() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND end = '".$valueObject->getEnd()."' ";
          }
