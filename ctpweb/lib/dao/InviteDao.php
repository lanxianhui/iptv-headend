<?php
 ...
 /**
  * Invite Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Invite object instances. 
  */
...
class InviteDao {
    ...
    function load(&$conn, &$valueObject) {
          ...
          $sql = "SELECT * FROM Invite WHERE (id = ".$valueObject->getId().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM Invite ORDER BY id ASC ";
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO Invite ( code, createdOn, userId) VALUES ('".$valueObject->getCode()."', ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE Invite SET code = '".$valueObject->getCode()."', ";
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM Invite WHERE (id = ".$valueObject->getId().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          if ($valueObject->getCode() != "") {
              if ($first) { $first = false; }
              $sql = $sql."AND code LIKE '".$valueObject->getCode()."%' ";
          }
    ...
    function singleQuery(&$conn, &$sql, &$valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setId($row[0]); 
                   $valueObject->setCode($row[1]); 
                   $valueObject->setCreatedOn($row[2]); 
                   $valueObject->setUserId($row[3]); 
          } else {
